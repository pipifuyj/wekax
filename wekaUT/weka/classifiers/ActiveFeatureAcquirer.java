...
public interface ActiveFeatureAcquirer {
     ...
     * @param activePool pool of examples with missing features
     * @param num number of examples to selcted for acquiring remaining features
     * @exception Exception if selective sampling fails
     */
    int [] selectInstancesForFeatures(Instances activePool,int num) throws Exception;
