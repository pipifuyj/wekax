...
public class ActiveDecorate extends DistributionClassifier implements OptionHandler, ActiveLearner{
    ...
    protected int m_SelectionScheme = JENSEN_SHANNON;
  ...
  public double[] distributionForInstance(Instance instance) throws Exception {
	...
	try {
	    System.out.println(Evaluation.evaluateModel(new ActiveDecorate(), argv));
	} catch (Exception e) {
