...
import weka.clusterers.ActiveLearningClusterer;
import weka.clusterers.SeededKMeans;

/**
 * N-fold cross-validation learning curve for point-wise active
 * learning in semi-supervised learners (clusterers and classifiers)
 *
 * @author Sugato Basu */
...
public class  SemiSupPointActiveCurveCVResultProducer 
  ...
  protected boolean m_DoActive = true;
  ...
  public void setAdditionalMeasures(String [] additionalMeasures) {
    ...
    if (m_SplitEvaluator != null) {
      System.err.println(" SemiSupPointActiveCurveCVResultProducer: setting additional "
			 +"measures for "
			 +"split evaluator");
  ...
  public double getMeasure(String additionalMeasureName) {
	...
	getMeasure(additionalMeasureName);
      ...
      throw new IllegalArgumentException(" SemiSupPointActiveCurveCVResultProducer: "
	...
	if (m_ResultListener.isResultRequired(this, key)) {
	  try {
	    ...
	    for (int i=0; i<m_CurrentSize; i++) {
	      System.out.println("Labeled instance " + i + " has label: " + labeledTrainSubset.instance(i).classValue());
	    }
  ...
  public String toString() {
    ...
    String result = "SemiSupPointActiveCurveCVResultProducer: ";
